...
<jsp:useBean id="s" class="com.bean.rating"></jsp:useBean>
...
boolean flag=s.insertrating(course, message);
...
<td>
     <div class="row">
          ...
          <div class="list-group">
            <a href="sjsucmpe272.jsp" class="list-group-item">CMPE 272--Enterprise Software Platforms</a>
            <a href="sjsucmpe202.jsp" class="list-group-item active">CMPE 202--Software System Engineering</a>
...
<div id="content">
    ...
    <div id="my-tab-content" class="tab-content">
        ...
        <div class="well">
            <h4>Details:</h4>
            <p align="left">
            Integrated approach to software design and development including requirements elicitation and analysis, 
            system design and construction through studying multiple
             facets of software development processes, design methodologies, modeling approaches, and implementation techniques.
            ...
            <a href="http://info.sjsu.edu/web-dbgen/catalog/courses/CMPE202.html">http://info.sjsu.edu/web-dbgen/catalog/courses/CMPE202.html</a>
        </div>
        </div>
        ...
        <div class="well">
            <h4>Instructors:</h4>
            <p>Prof Paul Nyugen & Prof Mohd Fayad</p>
        </div></div>
